  ...
  return (
      <div 
        ...
        <div id='Section5CardHover'> 
          <div id='Section5CardHover1'>
            {product.name}
          </div> 
          <div id='CartWrap'>
            <FaCartPlus size='20' style={{color:'white', position:'relative', top:'170px', left:'130px', cursor:'pointer'}} onClick={()=>{dispatch({type:"ADD"}); handleCart()}} />
          </div>
        </div>
        :
        <div id='CardWrap'>
